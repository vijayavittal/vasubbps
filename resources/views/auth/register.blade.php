...
<body>
<div class="container">
    <div style="text-align:center"><img class="mt-2 mb-5" src="images/logo.png" alt="photo" style="width:15%"></div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group form-group">
                        <input id="phone" maxlength="10" hidden type="number" class="form-control @error('phone') is-invalid @enderror" name="phone"  required autocomplete="phone">
                    ...
                    <div class="input-group form-group">
                        <span class="input-group-text"><i class='fas fa-mobile mx-1' style='font-size:23px'></i></span>
                    ...
                    <div class="input-group form-group">
                        <span class="input-group-text"><i class='fas fa-mobile mx-1' style='font-size:23px'></i></span>
                        <input id="company" placeholder="Company" type="text" class="form-control @error('company') is-invalid @enderror" name="company" value="{{ old('company') }}" required autocomplete="company" autofocus>
                    ...
                    <div class="input-group form-group">
                        <span class="input-group-text"><i class='fas fa-mobile mx-1' style='font-size:23px'></i></span>
                        <input id="pan" maxlength="10" placeholder="PAN" type="text" class="form-control @error('pan') is-invalid @enderror" name="pan" value="{{ old('pan') }}" required autocomplete="pan" autofocus>
                    ...
                    <div class="input-group form-group">
                        <span class="input-group-text"><i class='fas fa-mobile mx-1' style='font-size:23px'></i></span>
                        <input id="pincode" maxlength="6" placeholder="Pincode" type="number" class="form-control @error('pincode') is-invalid @enderror" name="pincode" value="{{ old('pincode') }}" required autocomplete="pincode" autofocus>
                    ...
                    <div class="input-group form-group">
                        <span class="input-group-text"><i class='fas fa-mobile mx-1' style='font-size:23px'></i></span>
                        <input id="otp" maxlength="6" type="number" placeholder="OTP"  class="form-control @error('otp') is-invalid @enderror" name="otp"  required autocomplete="otp">
                    ...
                    <div class="form-group input-group justify-content-center px-2">
