            ...
            <div class="card-body">
                <form method="POST" action="/phone">
                    ...
                    <div class="input-group form-group">
                        ...
                        <input id="phone" placeholder="Phone Number" maxlength="10" type="number" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus> @error('phone') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong> </span> @enderror
                    </div>
                    @error('password')
                    ...
                    <div class="form-group input-group justify-content-between px-2">
