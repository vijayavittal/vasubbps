                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="input-group form-group">
                                <span class="input-group-text"><i class='fas fa-user mx-1' style='font-size:23px'></i></span>
                        ...
                        <div class="input-group form-group">
                                <span class="input-group-text"><i class='fa fa-key mx-1' style='font-size:22px'></i></span>
                        ...
                        <div class="form-group input-group justify-content-between px-2">
                            ...
                            <a href="/phone" type="submit" class="btn bg-dark text-white">
                                {{ __('Register') }}
                            </a>
                        </div>
